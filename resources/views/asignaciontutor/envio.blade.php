        ...
        <div class="card-header">
            <h3 class="card-title">
                <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Tutor: {{$user->name}}</font>
                </font>
            </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('tutor_envio.enviocorreo', $user) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <div class="form-group col-md-12">
                        {!! Form::label('file', 'Archivo de asignación de tutor:') !!}
