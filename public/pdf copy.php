...
foreach ($reportes as $reporte) {
    ...
    if ($dia == 6 or $dia == 11 or $dia == 16 or $dia == 21 or $dia == 26 or $dia == 31 or $dia == 36 or $dia == 41 or $dia == 46 or $dia == 51 or $dia == 56 or $dia == 61 or $dia == 66 or $dia == 71 or $dia == 76 or $dia == 81 or $dia == 86 or $dia == 91 or $dia == 96 or $dia == 101) {
        ...
        $pdf->MultiCell(0, 7, utf8_decode('Apellidos y Nombres:  '), 0, 1);
    ...
    $pdf->SetY($celda);
    if ($numerodia == 1) {
        $pdf->Cell(20, 16, utf8_decode('LUNES'), 1, 0, "C");
    }
    if ($numerodia == 2) {
        $pdf->Cell(20, 16, utf8_decode('MARTES'), 1, 0, "C");
    }
    if ($numerodia == 3) {
        $pdf->Cell(20, 16, utf8_decode('MIERCOLES'), 1, 0, "C");
    }
    if ($numerodia == 4) {
        $pdf->Cell(20, 16, utf8_decode('JUEVES'), 1, 0, "C");
    }
    if ($numerodia == 5) {
        $pdf->Cell(20, 16, utf8_decode('VIERNES'), 1, 0, "C");
    }
    ...
    $celda = $celda + 16;
    if ($dia == 5 or $dia == 10 or $dia == 15 or $dia == 20 or $dia == 25 or $dia == 30 or $dia == 35 or $dia == 40 or $dia == 45 or $dia == 50 or $dia == 55 or $dia == 60 or $dia == 65 or $dia == 70 or $dia == 75 or $dia == 80 or $dia == 85 or $dia == 90 or $dia == 95 or $dia == 100) {
