...
$sql = 'select * from users where tipo_usuario = 0';
...
$pdf->Cell(0, 10, utf8_decode(' '), 0, 1, "C");
$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell(0, 10, utf8_decode('REPORTE DE TODOS LOS ESTUDIANTES DE PRACTICAS'), 0, 1, "C");
$pdf->Ln();
$pdf->AliasNbPages();
...
$pdf->Cell(25, 10, utf8_decode($reporte['id']), 1, 0, "C");

$pdf->Cell(70, 10, utf8_decode($reporte['name']), 1, 0, "C");

$pdf->Cell(45, 10, utf8_decode($reporte['cedula']), 1, 0, "C");

$pdf->Cell(50, 10, utf8_decode($reporte['email']), 1, 1, "C");
}
// output file
